...
class CashdropPaymentController(http.Controller):
    ...
    @http.route('/cashdro/payment/start', auth='user', type='json', methods=['POST'])
    ...
    @http.route('/cashdro/payment/confirm', auth='user', type='json', methods=['POST'])
    ...
    @http.route('/cashdro/payment/cancel', auth='user', type='json', methods=['POST'])
    ...
    @http.route('/cashdro/payment/status/<string:transaction_id>', 
                 auth='user', type='json', methods=['GET'])
    ...
    @http.route('/cashdro/payment/info', auth='user', type='json', methods=['POST'])
